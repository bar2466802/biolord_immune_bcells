...
python3 ${PROJECT_DIR}/train_model.py --n_latent_attribute_categorical ${n_latent_attribute_categorical} --reconstruction_penalty ${reconstruction_penalty} --unknown_attribute_penalty ${unknown_attribute_penalty} --unknown_attribute_noise_param ${unknown_attribute_noise_param} --id_ ${id_} --folder ${folder}